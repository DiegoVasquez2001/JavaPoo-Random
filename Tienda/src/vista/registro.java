 ...
 */
package vista;
/*declaracion de variables del area modelo*/
import modelo.Hash;
...
/*declaracion  de función principal  para ejecutar una clase, void: Indica el tipo de objeto que regresa la función*/
...
/*si debe  cumplir la siguiente condicon para registrar correctamente el usario e ingresar correctamente */
        if (txtUsuario.getText().equals("") || pass.equals("") || passC.equals("") || txtNombre.getText().equals("") || txtEmail.getText().equals("")) {
            /*error al no poner o llenar un campo correctamente*/
            ...
            if (pass.equals(passC)) {
                ...
                if (modSql.existeUsuario(txtUsuario.getText()) == 0) {
                    ...
                    if (modSql.esEmail(txtEmail.getText())) {
                        ...
                        mod.setIdTipo(1);
                       /*si cumple esta funcion se registra correctamente*/
                        if (modSql.registrar(mod)) {
                            JOptionPane.showMessageDialog(null, "Registro Guardado");
                            limpiar();
                            /*si no  cumple esta funcion se error al guardar  correctamente*/
                        } else {
                            JOptionPane.showMessageDialog(null, "Error al Guardar");
                            limpiar();
                        }
                        /*si no  cumple esta funcion  el correo no se  guardar  correctamente*/
                    } else {
                        JOptionPane.showMessageDialog(null, "El email es incorrecto");
                    }
                    /*funcion donde se detecta si existe el usario*/
                } else {
                    JOptionPane.showMessageDialog(null, "El usuario ya existe");
                }
                /*cuando hay un error en contraeña */
            } else {
...
/*codigo para limpiar la pantalla luego de registrar*/
